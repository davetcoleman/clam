"""autogenerated by genpy from clam_block_manipulation/ResetArmActionResult.msg. Do not edit."""
import sys
...
class ResetArmActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "clam_block_manipulation/ResetArmActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','clam_block_manipulation/ResetArmResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ResetArmActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = clam_block_manipulation.msg.ResetArmResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = clam_block_manipulation.msg.ResetArmResult()
