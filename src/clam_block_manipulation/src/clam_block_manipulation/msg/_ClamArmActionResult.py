"""autogenerated by genpy from clam_block_manipulation/ClamArmActionResult.msg. Do not edit."""
import sys
...
class ClamArmActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "clam_block_manipulation/ClamArmActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','clam_block_manipulation/ClamArmResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ClamArmActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = clam_block_manipulation.msg.ClamArmResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = clam_block_manipulation.msg.ClamArmResult()
