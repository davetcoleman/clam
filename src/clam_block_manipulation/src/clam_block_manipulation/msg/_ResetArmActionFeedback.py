"""autogenerated by genpy from clam_block_manipulation/ResetArmActionFeedback.msg. Do not edit."""
import sys
...
class ResetArmActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "clam_block_manipulation/ResetArmActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','clam_block_manipulation/ResetArmFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ResetArmActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = clam_block_manipulation.msg.ResetArmFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = clam_block_manipulation.msg.ResetArmFeedback()
