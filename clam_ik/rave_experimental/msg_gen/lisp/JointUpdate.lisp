...
;//! \htmlinclude JointUpdate.msg.html

(cl:defclass <JointUpdate> (roslisp-msg-protocol:ros-message)
  ((joint0
    :reader joint0
    :initarg :joint0
    :type cl:float
...
(cl:defclass JointUpdate (<JointUpdate>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <JointUpdate>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'JointUpdate)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rave_experimental-msg:<JointUpdate> is deprecated: use rave_experimental-msg:JointUpdate instead.")))

(cl:ensure-generic-function 'joint0-val :lambda-list '(m))
(cl:defmethod joint0-val ((m <JointUpdate>))
...
(cl:defmethod joint1-val ((m <JointUpdate>))
...
(cl:defmethod joint2-val ((m <JointUpdate>))
...
(cl:defmethod joint3-val ((m <JointUpdate>))
...
(cl:defmethod joint4-val ((m <JointUpdate>))
...
(cl:defmethod joint5-val ((m <JointUpdate>))
...
(cl:defmethod joint6-val ((m <JointUpdate>))
...
(cl:ensure-generic-function 'claw_close-val :lambda-list '(m))
(cl:defmethod claw_close-val ((m <JointUpdate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rave_experimental-msg:claw_close-val is deprecated.  Use rave_experimental-msg:claw_close instead.")
  (claw_close m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <JointUpdate>) ostream)
  "Serializes a message object of type '<JointUpdate>"
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'joint6))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'claw_close))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <JointUpdate>) istream)
  "Deserializes a message object of type '<JointUpdate>"
    (cl:let ((bits 0))
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'claw_close) (roslisp-utils:decode-single-float-bits bits)))
  msg
)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<JointUpdate>)))
  "Returns string type for a message object of type '<JointUpdate>"
  "rave_experimental/JointUpdate")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'JointUpdate)))
  "Returns string type for a message object of type 'JointUpdate"
  "rave_experimental/JointUpdate")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<JointUpdate>)))
  "Returns md5sum for a message object of type '<JointUpdate>"
  "a46f0ba7bf7e2a7c17324e3d889ecd42")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'JointUpdate)))
  "Returns md5sum for a message object of type 'JointUpdate"
  "a46f0ba7bf7e2a7c17324e3d889ecd42")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<JointUpdate>)))
  "Returns full string definition for message of type '<JointUpdate>"
  (cl:format cl:nil "float32 joint0~%float32 joint1~%float32 joint2~%float32 joint3~%float32 joint4~%float32 joint5~%float32 joint6~%float32 claw_close~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'JointUpdate)))
  "Returns full string definition for message of type 'JointUpdate"
  (cl:format cl:nil "float32 joint0~%float32 joint1~%float32 joint2~%float32 joint3~%float32 joint4~%float32 joint5~%float32 joint6~%float32 claw_close~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <JointUpdate>))
  (cl:+ 0
     4
     4
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <JointUpdate>))
  ...
  (cl:list 'JointUpdate
    ...
    (cl:cons ':claw_close (claw_close msg))
))
