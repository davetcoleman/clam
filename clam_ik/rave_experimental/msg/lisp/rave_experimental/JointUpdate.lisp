...
(defclass <JointUpdate> (ros-message)
  ((joint0
    :reader joint0-val
    :initarg :joint0
    :type float
...
(defmethod serialize ((msg <JointUpdate>) ostream)
...
(defmethod deserialize ((msg <JointUpdate>) istream)
...
(defmethod serialization-length ((msg <JointUpdate>))
  (+ 0
     4
     4
     4
...
(defmethod ros-message-to-list ((msg <JointUpdate>))
